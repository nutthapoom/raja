        ...
        <div class="container">
            <div class="clearfix">
                <div class="top-bar-text float_left">
                    ...
                    <p>Welcome to Donation charity & fundrising</p>
                </div>
                <div class="right-column float_right">
                    ...
                    <div class="signin-btn"><a href="account.html"><i class="fa fa-user"></i>Signin</a></div>
                ...
                <div class="pull-right upper-right clearfix">
                    ...
                    <div class="upper-column info-box">
                        ...
                        <ul>
                            ...
                            <li><a href="blog-details.html#">info@example.com</a></li>
                        </ul>
                    </div>
                    
                    <!--Info Box-->
                    <div class="upper-column info-box">
                        <div class="icon-box"><span class="icon-arrows"></span></div>
                        <ul>
                            <li><strong>Newyork, USA</strong></li>
                            <li>P6 12th Street, Olive Building</li>
                        </ul>
                    </div>
                    ...
                    <div class="upper-column info-box">
                        <div class="social-links-one">
                            <a href="blog-details.html#"><span class="fa fa-facebook-f"></span></a>
                            <a href="blog-details.html#"><span class="fa fa-twitter"></span></a>
                            <a href="blog-details.html#"><span class="fa fa-google-plus"></span></a>
                            <a href="blog-details.html#"><span class="fa fa-linkedin"></span></a>
                        </div>
                    </div>
            ...
            <div class="col-md-9 menu-column">
                <nav class="defaultmainmenu" id="main_menu">
                   <ul class="defaultmainmenu-menu">
                        ...
                        <li class="active"><a href="blog-details.html#">About Us</a>
                        <ul class="dropdown">
                        ...
                        <li><a href="blog-details.html#">Events</a>
                        <ul class="dropdown">
                        ...
                        <li><a href="blog-details.html#">Shop</a>
                        <ul class="dropdown">
            ...
            <div class="right-column">
                ...
                <div class="nav_side_content">
                    <ul class="social-icon">
                        <li><a href="blog-details.html#"><i class="fa fa-shopping-cart"></i></a></li>
                    </ul>
                    <div class="search_option">
                        <button class="search tran3s dropdown-toggle color1_bg" id="searchDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-search" aria-hidden="true"></i></button>
                        <form action="blog-details.html#" class="dropdown-menu" aria-labelledby="searchDropdown">
...
<div class="breadcumb-wrapper">
    <div class="container">
        ...
        <div class="pull-right">
            <a href="blog-details.html#" class="get-qoute"><i class="fa fa-arrow-circle-right"></i>Become a Volunteer</a>
        </div>
    </div>
</div>
                        ...
                        <div class="outer-box">
                            ...
                            <div class="post-author">
                                <div class="inner-box">
                                    ...
                                    <h4>Mark William</h4>
                                        <div class=""><p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p> 
                                        <ul class="list-inline social">
                                            <li>
                                            ...
                                            <li>
                                                <a href="blog-details.html#"><i class="fa fa-youtube"></i></a>                               
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="text-holder">
                                        <div class="top">
                                            <div class="name pull-left">
                                                <h4>Martin Guptil – jan 17, 2017:</h4>
                                            </div>
                                        ...
                                        <div class="text">
                                            <p>Legendos intellegam id usu, vide oporteat vix eu, id illud principes has. Nam tempor utamur gubergren no.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="single-comment">
                                    ...
                                    <div class="text-holder">
                                        <div class="top">
                                            <div class="name pull-left">
                                                <h4>Robert Boult – Feb 21, 2017:</h4>
                                            </div>
                                            <div class="rating pull-right">
                                                <ul>
                                                    <li><i class="fa fa-star"></i></li>
                            ...
                            <div class="default-form-area">
                                <form id="contact-form" name="contact_form" class="default-form" action="http://html.tonatheme.com/2017/Donation/inc/sendmail.php" method="post" novalidate="novalidate">
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <textarea name="form_message" class="form-control textarea required" placeholder="Your Comments" aria-required="true"></textarea>
                                            </div>
                                        </div>   
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="footer-widget about-column">
                                ...
                                <div class="text"><p>Exercitation ullamcoLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p> </div>
                                <div class="link"><a href="blog-details.html#" class="default_link">Read More <i class="fa fa-long-arrow-right"></i></a></div>
                            </div>
                        </div>
                        <!--Footer Column-->
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="footer-widget link-column">
                                ...
                                <div class="widget-content">
                                    <ul class="list">
                                        ...
                                        <li><a href="blog-details.html#">Our Donators</a></li>
                                        <li><a href="blog-details.html#">Sponsers</a></li>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="footer-widget post-column">
                                ...
                                <div class="post-list">
                                    <div class="post">
                                        <div class="post-thumb"><a href="blog-details.html#"><img src="images/blog/thumb1.jpg" alt=""></a></div>
                                        <a href="blog-details.html#"><h5>Donation food for childrens</h5></a>
                                        <div class="post-info"> 15 Mar, 2017</div>
                                    </div>
                                    <div class="post">
                                        <div class="post-thumb"><a href="blog-details.html#"><img src="images/blog/thumb2.jpg" alt=""></a></div>
                                        <a href="blog-details.html#"><h5>Helping Kids Grow Up Stronger</h5></a>
                                        <div class="post-info"> 21 Apr, 2017</div>
                                    </div>
                            ...
                            <div class="footer-widget contact-widget">
                                ...
                                <div class="widget-content">
                                    ...
                                    <ul class="contact-info">
                                        <li><div class="icon-box"><span class="icon-arrows"></span></div>Collins Street West,121 King Street, Melbourne.</li>
                                        <li><div class="icon-box"><span class="icon-phone"></span></div>+(11)123 456 7890, </li>
                                        <li><div class="icon-box"><span class="icon-back"></span></div>info@Samara.com</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<!--Footer Bottom-->                    
 <section class="footer-bottom">
    <div class="container">
        <p class="center"><a href="blog-details.html#">Copyrights © 2017</a> All Rights Reserved. Powered by <a href="blog-details.html#">Donation</a></p>
    </div><!-- /.container -->
</section>
    ...
    <div class="container">
        <div class="donate-form-area">
            ...
            <form  action="blog-details.html#" class="donate-form default-form">
