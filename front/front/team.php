...
<div class="inner-banner has-base-color-overlay text-center" style="background: url(../images/background/4.jpg);">
    <div class="container">
        <div class="box">
            <h1>คณะกรรมการบริหาร มูลนิธิโรงพยาบาลราชวิถี</h1>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="pull-left">
            <ul class="list-inline link-list">
                ...
                <li>
                    <a href="./team.php#">เกี่ยวกับมูลนิธิ</a>
                </li>
...
<section class="team-style-1 sec-padd2">
    <div class="container">
        ...
        <div class="row">
          <article class="col-md-6 col-sm-6 center">
              <div class="single-team-member">
                  <figure class="img-box">
        ...
        <div class="row">
          <article class="col-md-3 col-sm-6 center">
              <div class="single-team-member">
                  <figure class="img-box">
                      <img src="../images/content/pic3-1.png" alt="">
                  </figure>
                  <div class="author-info">
                      <h4>นายแพทย์มานัส  โพธาภรณ์</h4>
                      <p>กรรมการ</p>
          ...
          <article class="col-md-3 col-sm-6 center">
              <div class="single-team-member">
                  <figure class="img-box">
                      <img src="../images/content/pic3-2.jpg" alt="">
                  </figure>
                  <div class="author-info">
                      <h4>นายแพทย์มานัส  โพธาภรณ์</h4>
                      <p>กรรมการ</p>
          ...
          <article class="col-md-3 col-sm-6 center">
              <div class="single-team-member">
                  <figure class="img-box">
                      <img src="../images/content/pic3-3.jpg" alt="">
                  </figure>
                  <div class="author-info">
                      <h4>นายแพทย์มานัส  โพธาภรณ์</h4>
                      <p>กรรมการ</p>
          ...
          <article class="col-md-3 col-sm-6 center">
              <div class="single-team-member">
                  <figure class="img-box">
                      <img src="../images/content/pic3-4.jpg" alt="">
                  </figure>
                  <div class="author-info">
                      <h4>นายแพทย์มานัส  โพธาภรณ์</h4>
                      <p>กรรมการ</p>
        ...
        <div class="row">
          <article class="col-md-3 col-sm-6 center">
              <div class="single-team-member">
                  <figure class="img-box">
                      <img src="../images/content/pic4-1.jpg" alt="">
                  </figure>
                  <div class="author-info">
          ...
          <article class="col-md-3 col-sm-6 center">
              <div class="single-team-member">
                  <figure class="img-box">
                      <img src="../images/content/pic4-2.jpg" alt="">
                  </figure>
                  <div class="author-info">
          ...
          <article class="col-md-3 col-sm-6 center">
              <div class="single-team-member">
                  <figure class="img-box">
                      <img src="../images/content/pic4-3.jpg" alt="">
                  </figure>
                  <div class="author-info">
          ...
          <article class="col-md-3 col-sm-6 center">
              <div class="single-team-member">
                  <figure class="img-box">
                      <img src="../images/content/pic4-4.jpg" alt="">
                  </figure>
                  <div class="author-info">
        ...
        <div class="row">
          <article class="col-md-4 col-sm-6 center">
              <div class="single-team-member">
                  <figure class="img-box">
                      <img src="../images/content/pic5-1.jpg" alt="">
                  </figure>
                  <div class="author-info">
          ...
          <article class="col-md-4 col-sm-6 center">
              <div class="single-team-member">
                  <figure class="img-box">
                      <img src="../images/content/pic5-2.jpg" alt="">
                  </figure>
                  <div class="author-info">
          ...
          <article class="col-md-4 col-sm-6 center">
              <div class="single-team-member">
                  <figure class="img-box">
                      <img src="../images/content/pic5-3.jpg" alt="">
                  </figure>
                  <div class="author-info">
