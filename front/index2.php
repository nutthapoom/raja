        ...
        <ul>
            ...
            <li data-transition="fade">
                ...
                <div class="tp-caption  tp-resizeme"
                    ...
                    <div class="slide-content-box center">
                        <h1>Change Children’s Life & save!</h1>
                        <p>Give a helping hand to those who need it. Volunteers do notGive a helping hand to <br> those who need it. Volunteers do not
													<div class="slide-content-box" style="text-align:center">
 														 <div class="button">
 															 <a class="thm-btn style-3" href="index.html#">DONATE US</a>
 																<a class="thm-btn style-3" href="index.html#">OUT CAUSES</a>
 														 </div>
 												 </div>
											  </p>
                    </div>
                ...
                <!-- <div class="tp-caption tp-resizeme"
                    ...
                    <div class="slide-content-box" >
                        <div class="button">
                            <a class="thm-btn donate-box-btn" href="index.html#">donate aa</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="tp-caption tp-resizeme"
                    ...
                    <div class="slide-content-box">
                        <div class="button">
                            <a class="thm-btn style-3" href="http://html.tonatheme.com/2017/Donation/cause.html">our causes</a>
                        </div>
                    </div>
                </div> -->
            ...
            <li data-transition="fade">
                ...
                <!-- <div class="tp-caption tp-resizeme"
                    ...
                    <div class="slide-content-box">
                        <div class="button">
                            <a class="thm-btn donate-box-btn" href="index.html#">donate us</a>
                        </div>
                    </div>
                </div>
                <div class="tp-caption tp-resizeme"
        ...
        <div class="row">
            <article class="item col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="content">
                    ...
                    <div class="text center">
                        <a href="index.html#"><h4 class="title">Childrens to get their home</h4></a>
            ...
            <article class="item col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="content">
                    ...
                    <div class="text center">
                        <a href="index.html#"><h4 class="title">We encourage girls education</h4></a>
            ...
            <article class="item col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="content">
                    ...
                    <div class="text center">
                        <a href="index.html#"><h4 class="title">The people to help themselves</h4></a>
