    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          <div class="container">
            <h1>Causes</h1>
            <form action="../function/cause-add.php" method="post" enctype="multipart/form-data">
              <!-- Text input-->
              ...
              <div class="form-group row">
                <div class="col-sm-2">ประเภทการบริจาค</div>
                <div class="col-sm-10">
                    <select name="inputType" class="form-control">
                      <option value=" " > --- เลือกประเภทการบริจาค --- </option>
                        <?php
                          $query  = "SELECT * FROM t_cause_type ORDER BY ctype_id ASC";
              ...
              <div class="form-group row">
                <label for="inputTopic" class="col-sm-2 col-form-label">Link Youtube</label>
                <div class="col-sm-10">
