          ...
          <div class="container">
            ...
            <form action="../function/news-update.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputTopic" name="inputTopic" value="<?php echo $row['news_topic']; ?>">
                </div>
              </div>
              <div class="form-group row">
                <div class="col-sm-2">ประเภทข่าว</div>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputType" name="inputType" value="<?php echo $row['ntype_name']; ?>" readonly>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <div class="form-group">
                    <span><?php if ($row['news_img'] != ""){?><img src="../images/news/<?php echo $row['news_img']; ?>" width="auto" height="200"><?php }else {
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" id="inputDetails" name="inputDetail" rows="3"><?php echo $row['news_detail']; ?></textarea>
                </div>
              </div>
              <div class="form-group row">
