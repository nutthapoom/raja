      ...
      <div class="row">
        <div class="col-12">
          <div class="container">
            ...
            <form action="../function/activ-add.php" method="post" enctype="multipart/form-data">
              <!-- Text input-->
              <div class="form-group row">
                <label for="inputTopic" class="col-sm-2 col-form-label">หัวข้อกิจกรรม</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputTopic" name="inputTopic">
                </div>
              </div>
              <div class="form-group row">
                <div class="col-sm-2">ประเภทกิจกรรม</div>
                <div class="col-sm-10">
                    <select name="inputType" class="form-control">
                      <option value=" " > --- เลือกประเภทกิจกรรม --- </option>
                        <?php
                          $query  = "SELECT * FROM t_activ_type ORDER BY atype_id ASC";
